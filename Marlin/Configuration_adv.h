...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000
    ...
    #define BOOTSCREEN_TIMEOUT 4000      // (ms) Total Duration to display the boot screen(s)
      ...
      #define BOOT_MARLIN_LOGO_SMALL     // Show a smaller Marlin logo on the Boot Screen (s  lash)
    #endif
  #endif
...
#endif
//LCD Print Progress options for HM2_300 Vasko compile
