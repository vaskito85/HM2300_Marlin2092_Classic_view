...
#define STRING_CONFIG_H_AUTHOR "(Vasko, HM2_300)" // Who made the changes. || For Hellbot Magna 2 300 (change X and Y for other Magna)
...
#define DEFAULT_E1_STEP_PER_UNIT 400
...
#define DEFAULT_E1_MAX_FEDDRATE 50
...
#define DEFAULT_E1_MAX_ACCELERATION 800
...
#define INVERT_X_DIR false //True directo false invertido
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SA VE_INTERVAL 60 // (minutes) EEPROM save interval during print
#endif
